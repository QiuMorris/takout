		...
		<table width="99%" border="0" cellspacing="0" cellpadding="0" id="main">
			<tr>
				<td colspan="2" align="left" valign="top">
					<span class="time"><strong>欢迎登录！admin</strong><u>[超级管理员]</u></span>
					<div class="top"><span class="left">登录IP：127.0.0.1 &nbsp;&nbsp;&nbsp;&nbsp;如非您本人操作，请及时</span>
					</div>
			...
			<tr>
				<td align="left" valign="top" width="50%">
					...
					<div class="main-con">
						<font color="#538ec6">登陆者IP：192.168.1.156
						<br/>
					</div>
				</td>
