		...
		<form id="form1" runat="server" action="" method="post">
			<div class="Main">
				<ul>
					...
					<li class="middle_C"><span class="btn"><input name="btn-login" id="btn-login" type="image" src="images/login/btnlogin.gif" /></span></li>
					<li class="middle_D"></li>
					<li class="bottom_A"></li>
					<li class="bottom_B">食刻外卖后台管理系统&nbsp;&nbsp;</li>
				</ul>
			</div>
		</form>
        ...
        <script>
            $(document).ready(function(){
                $("#btn-login").click(function(){
                    ...
                    //alert(mob);
                    $.post("/ajax_guanliyuan.php?act=login",
                        {
                            p_number:mob,
                            p_password:password
                        },
