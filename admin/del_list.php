...
<!--							<th align="center" valign="middle" class="borderright">锁定</th>-->
                        ...
                        <?php foreach ($redel as $key=>$value):?>
                            <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
                                <td align="center" valign="middle" class="borderright borderbottom"><?php echo $value['del_id']?></td>
                                <td align="center" valign="middle" class="borderright borderbottom"><?php echo $value['del_name']?></td>
                                <td align="center" valign="middle" class="borderright borderbottom">骑手用户</td>
