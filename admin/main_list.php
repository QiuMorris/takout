...
<!--							<th align="center" valign="middle" class="borderright">锁定</th>-->
                        ...
                        <?php foreach ($recus as $key=>$value):?>
                            <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
                                ...
                                <td align="center" valign="middle" class="borderright borderbottom">普通用户</td>
...
<!--                                    <a href="add.html" target="mainFrame" onFocus="this.blur()" class="add">编辑</a><span class="gray">&nbsp;|&nbsp;</span>-->
                                    <a target="mainFrame" onclick="delete_add(<?php echo $value['cus_id'] ?>)"  class="add">删除</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
...
<!--				</td>-->
    ...
    <script>
        function delete_add(id) {
            $.post("/ajax_guanliyuan.php?act=delete_add",
                {
                    cus_id:id,
                },
