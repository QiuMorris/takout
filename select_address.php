                ...
                <div class="bottom clearfloat box-s">
                    <section class="shopcar clearfloat">
                        <div class="list listtwo clearfloat">
                            ...
                            <span class="mradd fl"><input name="select_add" id="select_add" type="radio" <?php if($valaddress['is_default']==1){?>checked<?php }?>  value="<?php echo $valaddress['id'] ?>">                                        选择此地址</span>
<!--                            <input type="hidden" name="id" id="id"  />-->
    ...
    <a href="javascript:history.go(-1)" class="address-add fl">
        确认我的选择
    </a>
</div>
